...
urlpatterns = [
    ...
    url(r'^register/success/$', views.user_created, name='register_success'), #mensaje que se muestra cuando se creo bien el nuevo usuario
    ...
    url(r'^accounts/logout/$', views.logout, name='logout'), #cerrar sesi&oacute;n
