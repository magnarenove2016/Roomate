...
urlpatterns = [
    ...
    #     name='password_reset'),
    # url(r'^accounts/password/reset/$', views.open_view, name='open_view' ,kwargs=dict(extra_context={'special': 'password_reset.html'})),
    url(r'^accounts/password/reset/$', views.open_view, name='password_reset.html'),

    # url(r'^accounts/password/reset/done/$',
    # auth_views.password_reset_done,
    # {'template_name' : 'web/es/password_reset_done.html'},
    # name='password_reset_done'),
    url(r'^accounts/password/reset/done/$', views.open_view, name='password_reset_done.html'),
    ...
    url(r'^accounts/password/reset/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', views.open_view, name='password_reset_confirm.html'),

    # url(r'^accounts/password/reset/complete/$',
    # auth_views.password_reset_complete,
    # {'template_name' : 'web/es/password_reset_complete.html'},
    # name='password_reset_complete'),
    url(r'^accounts/password/reset/complete/$', views.open_view, name='password_reset_complete.html'),
    ...
    url(r'^accounts/password/change/$', views.open_view, name='password_change.html'),

    # url(r'^accounts/password/change/done/$',
    # auth_views.password_change_done,
    # {'template_name' : 'web/es/password_change_done.html'},
    # name='password_change_done'),
    url(r'^accounts/password/change/done/$', views.open_view, name='password_change_done.html'),
